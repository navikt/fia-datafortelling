...
## Per modul
```{python}
modul_sortering = modul_sortering(data_leveranse_sistestatus_siste_år)
```
::: {.panel-tabset}
## Levert
```{python}
antall_leveranser_per_modul(
    data_leveranse_sistestatus_siste_år[data_leveranse_sistestatus_siste_år.status=="LEVERT"], modul_sortering
)
```
## Under arbeid
```{python}
antall_leveranser_per_modul(
    data_leveranse_sistestatus_siste_år[data_leveranse_sistestatus_siste_år.status == "UNDER_ARBEID"], modul_sortering
)
```
## Levert og under arbeid
```{python}
antall_leveranser_per_modul(data_leveranse_sistestatus_siste_år, modul_sortering)
```
:::
...
```{python}
moduler_per_maaned(data_leveranse_sistestatus_siste_år)
```
