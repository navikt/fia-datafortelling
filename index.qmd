...
virksomhetsprofil(data_input, title="Virksomhetsprofil av alle aktive saker")
```

## Vurderte
```{python}
data_input = data_statistikk[data_statistikk.status=="VURDERES"].drop_duplicates("saksnummer", keep="last")
virksomhetsprofil(data_input, title="Vurderte virksomheter")
```
...
virksomhetsprofil(data_input, title="Virksomheter vurderte ikke aktuell")
```
:::
