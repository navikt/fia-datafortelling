...
from datafortelling_utils.dataloader import last_inn_data_samarbeidsplan
...
```{python}
from datafortelling_utils.samarbeid import trakt_antall_samarbeid
...
# Antall
```{python}
from datafortelling_utils.samarbeid import plot_antall_saker_per_antall_samarbeid
...
```{python}
from datafortelling_utils.samarbeid import plot_antall_samarbeid_over_tid
...
```{python}
from datafortelling_utils.samarbeid import plot_gjennomførte_spørreundersøkelser_over_tid
...
```{python}
from datafortelling_utils.konstanter import Sektor
from datafortelling_utils.datahandler import samarbeid_med_spørreundersøkelse
...
```{python}
from datafortelling_utils.samarbeid import  plot_tid_mellom_hendelser
