...
def antall_saker_indicator(data_status):
    ...
    fig.add_trace(
        go.Indicator(
            ...
            value=data_status[data_status.aktiv_sak].saksnummer.nunique(),
            number={"valueformat": ","},
        ),
        row=1,
        col=2,
