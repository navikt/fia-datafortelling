...
from plots_samarbeid import plot_antall_saker_per_antall_samarbeid
from helper import (
...
data_leveranse = legg_til_resultatområde(data_leveranse, data_statistikk)
...
data_samarbeid = legg_til_resultatområde(data_samarbeid, data_statistikk)

# Filtrere på resultatområde
...
data_samarbeid_resultatområde = data_samarbeid[data_samarbeid.resultatomrade == resultatområde]
```
...
## Antall samarbeider per virksomhet
::: {.panel-tabset}
# Andel
```{python}
