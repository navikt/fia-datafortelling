...
from src.plots.plots_statistikk import (
    statusflyt,
...
tabell_spørreundersøkelse="sporreundersokelse-v1"
data_behovsvurdering = load_data_deduplicate(PROJECT, DATASET, tabell_spørreundersøkelse, distinct_colunms="id")
