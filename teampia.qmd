...
antall_behovsvurdering = (~df_bv.paabegynt.isna() & ~df_bv.avsluttet.isna()).sum()
dict(
    icon = "",
    color = "light",
    value = antall_behovsvurdering
)
```
    ...
    fig.add_trace(
        go.Sankey(
            node=dict(
                ...
                y=[0.5, 0.5, 0.55, 0.85, 0.2],
            ),
            link=dict(
                source=[0, 1, 2, 1, 3, 1, 2],
                target=[1, 2, 3, 3, 4, 4, 4],
                value=[
                    opprettet,
                    opprettet_til_paabegynt,
                    paabegynt_til_avsluttet,
                    opprettet_til_avsluttet,
