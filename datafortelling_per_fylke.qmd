...
for nr, navn in navkontor.items():
    if navn == fylkesnavn:
        resultatområde = navn
...
raw_data_leveranse = raw_data_leveranse.merge(
    data_statistikk[["saksnummer", "fylkesnummer", "bransjeprogram", "navkontor"]], 
    how='left', 
    on='saksnummer',
)
...
data_statistikk_fylke = data_statistikk[data_statistikk.navkontor == resultatområde]
data_status_fylke = data_status[data_status.navkontor == resultatområde]
data_eierskap_fylke = data_eierskap[data_eierskap.navkontor == resultatområde]
data_leveranse_fylke = data_leveranse[data_leveranse.navkontor == resultatområde]
data_leveranse_sistestatus_fylke = data_leveranse_sistestatus[data_leveranse_sistestatus.navkontor == resultatområde]
ikke_aktuell_fylke = ikke_aktuell[ikke_aktuell.navkontor == resultatområde]
```
