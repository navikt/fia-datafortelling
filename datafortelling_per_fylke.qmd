...
from code.plots_datakvalitet import saker_per_status_over_tid
...
fylkesnr = "50"
raw_data_leveranse = raw_data_leveranse.merge(raw_data_statistikk[["saksnummer", "fylkesnummer"]], how='left', on='saksnummer')
...
## Per modul
```{python}
modul_sortering = modul_sortering(data_siste_leveranse_fylke)
```
::: {.panel-tabset}
## Levert
```{python}
