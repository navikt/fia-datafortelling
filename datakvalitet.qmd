...
## Til Kontaktes
```{python}
dager_mellom_statusendringer(data_status, "VURDERES", "KONTAKTES", intervall_sortering)
```
## Til Ikke aktuell
```{python}
dager_mellom_statusendringer(data_status, "VURDERES", "IKKE_AKTUELL", intervall_sortering)
```
## Til Slettet
```{python}
dager_mellom_statusendringer(data_status, "VURDERES", "SLETTET", intervall_sortering)
```
:::
...
## Til Kartlegges
```{python}
dager_mellom_statusendringer(data_status, "KONTAKTES", "KARTLEGGES", intervall_sortering)
```
## Til Ikke aktuell
```{python}
dager_mellom_statusendringer(data_status, "KONTAKTES", "IKKE_AKTUELL", intervall_sortering)
```
:::
...
## Til Vi bistår
```{python}
dager_mellom_statusendringer(data_status, "KARTLEGGES", "VI_BISTÅR", intervall_sortering)
```
## Til Ikke aktuell
```{python}
dager_mellom_statusendringer(data_status, "KARTLEGGES", "IKKE_AKTUELL", intervall_sortering)
```
:::
...
## Til Fullført
```{python}
dager_mellom_statusendringer(data_status, "VI_BISTÅR", "FULLFØRT", intervall_sortering)
```
## Til Ikke aktuell
```{python}
dager_mellom_statusendringer(data_status, "VI_BISTÅR", "IKKE_AKTUELL", intervall_sortering)
```
:::
:::
