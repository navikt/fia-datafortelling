...
## Til Kontaktes
```{python}
dager_mellom_statusendringer(data_status, "VURDERES", "KONTAKTES")
```
```{python}
median_og_gjennomsnitt_av_tid_mellom_statusendringer(data_status, "VURDERES", "KONTAKTES")
```
## Til Ikke aktuell
```{python}
dager_mellom_statusendringer(data_status, "VURDERES", "IKKE_AKTUELL")
```
```{python}
median_og_gjennomsnitt_av_tid_mellom_statusendringer(data_status, "VURDERES", "IKKE_AKTUELL")
```
## Til Slettet
```{python}
dager_mellom_statusendringer(data_status, "VURDERES", "SLETTET")
```
```{python}
median_og_gjennomsnitt_av_tid_mellom_statusendringer(data_status, "VURDERES", "SLETTET")
```
## Til Kontaktes, Ikke aktuell eller Slettet
```{python}
dager_mellom_statusendringer(data_status, "VURDERES")
```
```{python}
median_og_gjennomsnitt_av_tid_mellom_statusendringer(data_status, "VURDERES")
```
:::
...
## Til Kartlegges
```{python}
dager_mellom_statusendringer(data_status, "KONTAKTES", "KARTLEGGES")
```
```{python}
median_og_gjennomsnitt_av_tid_mellom_statusendringer(data_status, "KONTAKTES", "KARTLEGGES")
```
## Til Ikke aktuell
```{python}
dager_mellom_statusendringer(data_status, "KONTAKTES", "IKKE_AKTUELL")
```
```{python}
median_og_gjennomsnitt_av_tid_mellom_statusendringer(data_status, "KONTAKTES", "IKKE_AKTUELL")
```
## Til Kartlegges eller Ikke aktuell
```{python}
dager_mellom_statusendringer(data_status, "KONTAKTES")
```
```{python}
median_og_gjennomsnitt_av_tid_mellom_statusendringer(data_status, "KONTAKTES")
```
:::
...
## Til Vi bistår
```{python}
dager_mellom_statusendringer(data_status, "KARTLEGGES", "VI_BISTÅR")
```
```{python}
median_og_gjennomsnitt_av_tid_mellom_statusendringer(data_status, "KARTLEGGES", "VI_BISTÅR")
```
## Til Ikke aktuell
```{python}
dager_mellom_statusendringer(data_status, "KARTLEGGES", "IKKE_AKTUELL")
```
```{python}
median_og_gjennomsnitt_av_tid_mellom_statusendringer(data_status, "KARTLEGGES", "IKKE_AKTUELL")
```
## Til Vi bistår eller Ikke aktuell
```{python}
dager_mellom_statusendringer(data_status, "KARTLEGGES")
```
```{python}
median_og_gjennomsnitt_av_tid_mellom_statusendringer(data_status, "KARTLEGGES")
```
:::
...
## Til Fullført
```{python}
dager_mellom_statusendringer(data_status, "VI_BISTÅR", "FULLFØRT")
```
```{python}
median_og_gjennomsnitt_av_tid_mellom_statusendringer(data_status, "VI_BISTÅR", "FULLFØRT")
```
## Til Ikke aktuell
```{python}
dager_mellom_statusendringer(data_status, "VI_BISTÅR", "IKKE_AKTUELL")
```
```{python}
median_og_gjennomsnitt_av_tid_mellom_statusendringer(data_status, "VI_BISTÅR", "IKKE_AKTUELL")
```
## Til Fullført eller Ikke aktuell
```{python}
dager_mellom_statusendringer(data_status, "VI_BISTÅR")
```
```{python}
median_og_gjennomsnitt_av_tid_mellom_statusendringer(data_status, "VI_BISTÅR")
```
:::
:::
