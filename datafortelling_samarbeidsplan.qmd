...
For alle samarbeid med en plan er det `{python} antall_planer_med_innhold` av `{python} antall_planer_totalt` planer som har noe innhold. (`{python} antall_planer_totalt-antall_planer_med_innhold` har ikke inkludert undertemaer i samarbeidsplanen enda).
...
For aktive samarbeid med en plan er det `{python} antall_planer_med_innhold` av `{python} antall_planer_totalt` planer som har noe innhold. (`{python} antall_planer_totalt-antall_planer_med_innhold` har ikke inkludert undertemaer i samarbeidsplanen enda).
...
For fullførte samarbeid med en plan er det `{python} antall_planer_med_innhold` av `{python} antall_planer_totalt` planer som har noe innhold. (`{python} antall_planer_totalt-antall_planer_med_innhold` har ikke inkludert undertemaer i samarbeidsplanen enda).
...
For avbrutte samarbeid med en plan er det `{python} antall_planer_med_innhold` av `{python} antall_planer_totalt` planer som har noe innhold. (`{python} antall_planer_totalt-antall_planer_med_innhold` har ikke inkludert undertemaer i samarbeidsplanen enda).
